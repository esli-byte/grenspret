...
const NAV_ITEMS: NavItem[] = [
  {
    ...
    icon: (active: boolean) => (
      <svg className="h-5 w-5" fill={active ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={active ? 0 : 1.8} stroke="currentColor">
        {active ? (
          <path d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 01-.53 1.28h-1.44v7.44a.75.75 0 01-.75.75h-3.75a.75.75 0 01-.75-.75V16.5a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75v4.75a.75.75 0 01-.75.75H6.5a.75.75 0 01-.75-.75v-7.44H4.31a.75.75 0 01-.53-1.28l8.69-8.69z" />
        ) : (
        ...
        {visibleItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {active && (
                <div className="absolute -top-0.5 left-1/2 h-1 w-8 -translate-x-1/2 rounded-full bg-accent animate-badge-pop" />
              )}
            </Link>
          );
        })}
